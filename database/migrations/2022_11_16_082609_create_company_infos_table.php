...
class CreateCompanyInfosTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('company_infos', function (Blueprint $table) {
            ...
            $table->string('company_multiple_phone')->nullable();
            $table->string('company_email')->nullable();
            $table->string('company_website')->nullable();
            $table->string('recruting_license_no')->nullable();
            ...
            $table->string('company_passport_limit')->nullable();
            $table->string('company_user_limit')->nullable();
