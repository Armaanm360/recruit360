...
class CreateClientTransectionsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('client_transections', function (Blueprint $table) {
            ...
            $table->string('client_account_create_date')->nullable();
            $table->string('client_account_has_deleted')->default('NO');
            $table->string('client_account_deleted_by');
            $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('client_transections');
    }
}
