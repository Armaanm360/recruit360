                            ...
                            <div class="col-md-12 col-lg-12">
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control" name="section_name" value="{{ $permission_data->section_name }}" id="section_name" placeholder="Permission Section">
                                   <input type="hidden" name="id" value="{{ $permission_data->id }}">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="optionBox">
                                            <div class="block">
                                                <input type="text" class="form-control" name="name[]" id="name.0" value="{{ $permission_data->name }}" placeholder="Permission Name">
...
<script>
    ...
    $("#add_btn").click(function (){
        ...
        $.ajax({
            ...
            method: "POST",
            url: "{{url("permissions")}}/"+ $("[name=id]").val(),
            data: data,
            cache: false,
            contentType: false,
            processData: false,
