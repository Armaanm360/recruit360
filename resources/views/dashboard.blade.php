...
@section('content')
    ...
    <?php
    //echo '<pre>';  print_r($dashboard->last_seven_sponsors());die;
    ?>
    <!-- start: page toolbar -->
        ...
        <div class="container-fluid">
            <div class="row g-3 row-deck">
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="card overflow-hidden">
                        <div class="card-body">
                            ...
                            <div class="mb-2 text-uppercase">TODAY SALES</div>
                            <div><span class="h4">TK. {{ $dashboard->get_today_sales() }}</span> <span
                                    class="small text-muted"><i class="fa fa-level-up"></i> 13%</span></div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="card overflow-hidden">
                        <div class="card-body">
                            ...
                            <div class="mb-2 text-uppercase">TODAY SALES PROFIT</div>
                            <div><span class="h4">TK. {{ $dashboard->get_today_profit() }}</span> <span
                                    class="small text-muted"><i class="fa fa-level-up"></i> 55%</span></div>
                            <small class="text-muted">Analytics for today</small>
                        </div>
                        <div class="progress" style="height: 4px;">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="card overflow-hidden">
                        <div class="card-body">
                            ...
                            <div class="mb-2 text-uppercase">TODAY EXPENSE</div>
                            <div><span class="h4">Tk. {{ $dashboard->get_today_expense() }}</span> <span
                                    class="small text-muted"><i class="fa fa-level-up"></i> 13%</span></div>
                            <small class="text-muted">Analytics for today</small>
                        </div>
                        <div class="progress" style="height: 4px;">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="card overflow-hidden">
                        <div class="card-body">
                            ...
                            <div class="mb-2 text-uppercase">TODAY COLLECTION</div>
                            <div><span class="h4">Tk. {{ $dashboard->get_today_collection() }}</span> <span
                                    class="small text-muted"><i class="fa fa-level-up"></i> 78%</span>
                            </div>
                            <small class="text-muted">Analytics for today</small>
                        </div>
                        <div class="progress" style="height: 4px;">
                ...
                <div class="col-xxl-3 col-xl-4 col-lg-4 col-sm-12">
                    <div class="card bg-primary-gradient text-light position-relative">
                        <div class="card-body">

                            <h4 class="mb-0">TODAY PROFIT <br> <span class="py-5 d-block"><Strong>TK.
                                        {{ $dashboard->get_today_profit() }}</Strong></span></h4>
                            <div class="py-4">
                                <?php
                                echo '' . date('Y/m/d') . '<br>';
                                echo '' . date('l');
                      ...
                      <button class="btn btn-dark" data-bs-toggle="modal" data-bs-target="#CreateCampaigns">Create New</button> --}}
                        </div>
                        <svg class="position-absolute bottom-0 end-0" data-name="Layer 1"
                            xmlns="http://www.w3.org/2000/svg" width="251.99951" height="127.00734"
                            ...
                            <path d="M642.01079,701.02149s20,41,6,46-32,1-36,7-48,13-49-2,48-43,48-43l6.38294-10.278Z"
                                transform="translate(-171.00024 -88.99633)" fill="#2f2e41"></path>
                            <path d="M804.01079,731.02149s20,41,6,46-32,1-36,7-48,13-49-2,48-43,48-43l6.38294-10.278Z"
                                transform="translate(-171.00024 -88.99633)" fill="#2f2e41"></path>
                            ...
                            <path
                                ...
                                transform="translate(-171.00024 -88.99633)" fill="#6c63ff"></path>
                            <path
                ...
                <div class="col-xxl-6 col-xl-8 col-lg-8 col-sm-12">
                    <div class="card">
                        <div class="card-header">
                            <h6 class="card-title m-0">REVENUE STATISTICS</h6>
                ...
                <div class="col-xxl-3 col-xl-4 col-lg-4 col-sm-12">
                    <div class="card text-center text-white bg-success">
                        <div class="card-body d-flex align-items-center justify-content-center">
                            <div>
                                <h4 class="mt-4">Welcome Back, {{ Auth::user()->name }}!!</h4>
                                <p class="card-text fs-6 mb-5"><strong>Need help?</strong> Check out the documentation of
                                    Recruitment Management. It
                                    includes
                                    tons of <strong>Widgets</strong>, <strong>Components</strong>, and Elements with
                                    <strong>easy-to-follow</strong>
                                    documentation.
                                </p>
                                <a class="btn btn-lg bg-white text-uppercase px-4 lift" href="#"
                                    title="">Visit
                                    Documentation</a>
                            </div>
                        </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="card overflow-hidden">
                        <div class="card-body">
                            ...
                            <div class="mb-2 text-uppercase">MONTH SALES</div>
                            <div><span class="h4">TK. {{ $dashboard->get_today_sales() }}</span> <span
                                    class="small text-muted"><i class="fa fa-level-up"></i> 13%</span></div>
                            <small class="text-muted">Analytics for Month</small>
                        </div>
                        <div class="progress" style="height: 4px;">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="card overflow-hidden">
                        <div class="card-body">
                            ...
                            <div class="mb-2 text-uppercase">MONTH SALES PROFIT</div>
                            <div><span class="h4">TK. {{ $dashboard->get_today_profit() }}</span> <span
                                    class="small text-muted"><i class="fa fa-level-up"></i> 55%</span></div>
                            <small class="text-muted">Analytics for Month</small>
                        </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="card overflow-hidden">
                        <div class="card-body">
                            ...
                            <div class="mb-2 text-uppercase">MONTH EXPENSE</div>
                            <div><span class="h4">Tk. {{ $dashboard->get_today_expense() }}</span> <span
                                    class="small text-muted"><i class="fa fa-level-up"></i> 13%</span></div>
                            <small class="text-muted">Analytics for Month</small>
                        </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="card overflow-hidden">
                        <div class="card-body">
                            ...
                            <div class="mb-2 text-uppercase">MONTH COLLECTION</div>
                            <div><span class="h4">Tk. {{ $dashboard->get_today_collection() }}</span> <span
                                    class="small text-muted"><i class="fa fa-level-up"></i> 78%</span>
                            </div>
                            <small class="text-muted">Analytics for Month</small>
                        ...
                        <div class="card-header">
                            ...
                            <div class="dropdown morphing scale-left">
                                ...
                                <a href="#" class="more-icon dropdown-toggle" data-bs-toggle="dropdown"
                                    aria-expanded="false"><i class="fa fa-ellipsis-h"></i></a>
                                <ul class="dropdown-menu shadow border-0 p-2">
                                    <li><a class="dropdown-item" href="{{ url('clients') }}">List Of Clients</a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="card-body">
                            <div>Available TK</div>
                            <h3>{{ $dashboard->total_of_clients() }}</h3>
                            <div class="py-2">
                                @php
                                    $sl = 0;
                                @endphp
                                @foreach ($dashboard->list_of_clients() as $client)
                                    @php
                                        $sl++;
                                    @endphp
                                    <div class="py-1">
                                        <div class="text-uppercase text-muted small">{{ $client->client_name }}</div>
                                        <h5>TK. {{ get_client_current_balance_by_client_id($client->client_id) }}</h5>
                                    </div>
                                @endforeach
                                <small class="text-muted">Showing {{ $sl }} Clients.</small>
                            </div>
                        ...
                        <div class="card-header">
                            ...
                            <div class="dropdown morphing scale-left">
                                ...
                                <a href="#" class="more-icon dropdown-toggle" data-bs-toggle="dropdown"
                                    aria-expanded="false"><i class="fa fa-ellipsis-h"></i></a>
                                <ul class="dropdown-menu shadow border-0 p-2">
                                    <li><a class="dropdown-item" href="{{ url('invoice') }}">list Of Invoice</a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="card-body">
                            <ul class="list-unstyled">
                                @php
                                    $sl = 0;
                                @endphp
                                @foreach ($dashboard->last_five_invoice() as $invoice)
                                    @php
                                        $sl++;
                                    @endphp
                                    <li class="d-flex py-2 mb-2">
                                        <div class="avatar rounded no-thumbnail"><i class="fa fa-file-zip-o fa-lg"></i>
                                        </div>
                                        <div class="flex-fill ms-3">
                                            <span>{{ $invoice->client_name }} - TK. {{ $invoice->invoice_net_total }} -
                            ...
                            <small class="text-muted">Showing {{ $sl }} Invoice.</small>
                        </div>
                    </div>
                </div>
                <div class="col-xxl-6 col-xl-12 col-lg-12 col-md-6">
                    <div class="card">
                        <div class="card-header">
                            <h6 class="card-title m-0">Cashbook</h6>
                            <!-- widgest: Card more action icon -->
                            <div class="dropdown morphing scale-left">
                                <a href="#" class="card-fullscreen" data-bs-toggle="tooltip"
                                    title="Card Full-Screen"><i class="icon-size-fullscreen"></i></a>
                                <a href="#" class="more-icon dropdown-toggle" data-bs-toggle="dropdown"
                                    aria-expanded="false"><i class="fa fa-ellipsis-h"></i></a>
                                <ul class="dropdown-menu shadow border-0 p-2">
                                    <li><a class="dropdown-item" href="{{ url('accounts') }}">List Of Account</a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="card-body">
                            <h3>TK. {{ $dashboard->total_of_accounts() }}</h3>
                            <!-- Progress -->
                        ...
                        <div class="table-responsive border-top">
                            <table class="table card-table table-nowrap mb-0">
                                <tbody>
                                    ...
                                    @foreach ($dashboard->list_of_accounts() as $account)
                                        <tr>
                                            <td><i
                                                    class="fa fa-circle me-2 chart-text-color1"></i>{{ $account->account_name }}
                                            </td>
                                            <td>TK.{{ get_acoount_current_balance_by_account_id($account->account_id) }}
                                            </td>
                                            <td><span class="badge bg-success">{{ $account->account_bank_name }}</span>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
