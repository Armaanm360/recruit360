...
@section('content')
                ...
                <div class="col">
                    <ol class="breadcrumb bg-transparent mb-0">
                        ...
                        <li class="breadcrumb-item"><a class="text-secondary" href="{{ url('/final-medical-test') }}">Final
                                Medical
                                Test</a></li>
                        <li class="breadcrumb-item active">Edit Final Medical Test</li>
                    </ol>
                </div>
            </div> <!-- .row end -->
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form class="row g-3 maskking-form" id="FinalMedicalTestForm">
                                ...
                                <input type="hidden" class="form-control form-control-lg" id="final_medical_test_id"
                                    name="final_medical_test_id" value="{{ $finalmedicaltest[0]->final_medical_test_id }}">
                                ...
                                {{-- <div class="col-6">
                                    ...
                                    <span class="float-label">
                                        ...
                                        <input type="text" class="form-control form-control-lg"
                                            id="final_medical_test_vendor_name" placeholder="Medical Id"
                                            name="final_medical_test_vendor_name"
                                            value="{{ $finalmedicaltest[0]->vendor_name }}">

                                        <input type="hidden" class="form-control form-control-lg"
                                            id="final_medical_test_vendor_id" name="final_medical_test_vendor_id"
                                            value="{{ $finalmedicaltest[0]->final_medical_test_vendor_id }}">

                                        <label class="form-label" for="medical_test_medical_id">Vendor Name</label>
                                    </span>
                                </div> --}}
                                <div class="col-6">
                                    ...
                                    <span class="float-label">
                                        ...
                                        <input type="text" class="form-control form-control-lg"
                                            id="final_medical_test_client_name" placeholder="Client Name"
                                            value="{{ $finalmedicaltest[0]->client_name }}">

                                        <input type="hidden" class="form-control form-control-lg"
                                            id="final_medical_test_client_id" placeholder="Client Name"
                                            name="final_medical_test_client_id"
                                            value="{{ $finalmedicaltest[0]->final_medical_test_client_id }}">
                                ...
                                <div class="col-6">
                                    <label class="form-group float-label">
                                        <select class="form-control form-control-lg custom-select"
                                            ...
                                            <option value="fit" @if ($finalmedicaltest[0]->final_medical_test_client_status == 'fit') selected @endif>Fit
                                            </option>
                                            <option value="unfit" @if ($finalmedicaltest[0]->final_medical_test_client_status == 'unfit') selected @endif>Unfit
                                            </option>
                                        </select>
                                ...
                                {{-- <div class="col-6">
                                    <span class="float-label">
                                        <input type="text" class="form-control form-control-lg" id="visa_amount"
                                            ...
                                            value="{{ $finalmedicaltest[0]->final_medical_test_processing_cost }}">
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-6" id="note">
                                    <span class="float-label">
                                        <textarea name="note" class="form-control">{{ $finalmedicaltest[0]->note }}</textarea>
    ...
    // let note = $('#note').hide();
        ...
        $("#FinalMedicalTestForm").submit(function(e) {
            e.preventDefault();
            $(".error_msg").html('');
            var data = $('#FinalMedicalTestForm').serializeArray();
            $.ajax({
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                },
                method: "PATCH",
                url: "{{ url('final-medical-test') }}/" + $("[name=final_medical_test_id]").val(),
                data: data,
                cache: false,
                success: function(data, textStatus, jqXHR) {
                    ...
                    Swal.fire({
                        position: 'top-end',
                        icon: 'success',
                        title: 'Final Medical Test Information has been updated successfully.',
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#final_medical_test_medical_name').autocomplete({
                html: true,
                ...
                select: function(event, ui) {
                    ...
                    $('#final_medical_test_id').val(ui.item.value);
                    return false;
                },
                minLength: 1,
                open: function() {
                ...
                close: function() {
                    ...
                    if ($('#final_medical_test_id').val() == '') {
                        $(this).val('');
                        $('#final_medical_test_id').val('');
                    }
                    $(this).removeClass("ui-corner-top").addClass("ui-corner-all");
                }
            });

            $('#final_medical_test_client_name').autocomplete({
                html: true,
                source: function(request, response) {
                    $.ajax({
                        type: "GET",
                ...
                select: function(event, ui) {
                    $(this).val(ui.item.label);
                    $('#final_medical_test_client_id').val(ui.item.value);
                    $.ajax({
                    method: "GET",
                ...
                close: function() {
                    ...
                    if ($('#final_medical_test_client_id').val() == '') {
                        $(this).val('');
                        $('#final_medical_test_client_id').val('');
                    }
                    $(this).removeClass("ui-corner-top").addClass("ui-corner-all");
                }
            });
            $('#final_medical_test_vendor_name').autocomplete({
                html: true,
                source: function(request, response) {
                    $.ajax({
                        type: "GET",
