    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                    ...
                    <ul class="nav nav-tabs tab-card border-bottom-0 pt-2 fs-6 justify-content-center justify-content-md-start"
                        ...
                        <li class="nav-item"><a class="nav-link" data-bs-toggle="tab" href="#policeclearance"
                                role="tab"><i class="fa fa-font"></i><span class="d-none d-md-inline-block ms-2">Police
                                    Clearence</span></a></li>
                        <li class="nav-item"><a class="nav-link" data-bs-toggle="tab" href="#musaned"
                                role="tab"><i class="fa fa-font"></i><span class="d-none d-md-inline-block ms-2">
                                    Musaned Data</span></a></li>
                    </ul>
                </div>
              ...
              <div class="tab-pane fade" id="musaned" role="tabpanel">


                        <div class="card">
                            <div class="card-body">
                            <h5 class="mb-1"><a href="app-project-detail.html" class="color-600">Musaned Data</a></h5>
                            <ul class="list-inline d-flex my-4">
                                <li class="list-inline-item card py-2 px-xxl-3 px-xl-2 px-3">
                                <h6 class="mb-1">Musaned Status</h6>
                                <small class="text-muted">{{$client[0]->musaned}}</small>
                                </li>
                                <li class="list-inline-item card py-2 px-xxl-3 px-xl-2 px-3">
                                <h6 class="mb-1">Musaned Number</h6>
                                <small class="text-muted">{{$client[0]->musaned_number}}</small>
                                </li>
                                <li class="list-inline-item card py-2 px-xxl-3 px-xl-2 px-3">
                                <h6 class="mb-1">Musaned Date</h6>
                                <small class="text-muted">{{$client[0]->musaned_date}}</small>
                                </li>
                            </ul>
