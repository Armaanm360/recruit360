                                ...
                                <div class="col-lg-3 col-sm-12">
                                    <span class="float-label">
                                        <input type="text" class="form-control form-control-lg" id="agentID"
                                            placeholder="Search Agent" name="agent_name" @if  ($agentData) value="{{$agentData->agent_name}}" @endif  required>
                                        <label class="form-label" for="agentID">Search Agent </label>
                                    </span>
                                    <input type="hidden" id="hiddenAgentID" name="agent_id" @if  ($agentData) value="{{$agentData->agent_id}}" @endif>
                                </div>
                                <div class="col-lg-3 col-sm-12">
                                    <span class="float-label">
                                        <input type="text" class="form-control form-control-lg" id="searchDeligate"
                                            placeholder="Search Deligate" name="deligate_name" @if  ($deligateData) value="{{$deligateData->deligate_name}}" @endif  required>
                                        <label class="form-label" for="hiddenDeligateID">Search Deligate </label>
                                    </span>
                                    <input type="hidden" id="hiddenDeligateID" name="deligate_id" @if  ($deligateData) value="{{$deligateData->deligate_id}}" @endif>
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-6">
                                    <span class="float-label">
