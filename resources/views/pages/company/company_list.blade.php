    ...
    <div class="card">
     <div class="card-body">
      <div class="input-group">
       ...
       <a class="btn btn-primary" href="{{url('companyinfo/create')}}" type="button">Add Company</a>
      </div>
    ...
    <table id="myDataTable_no_filter" class="table myDataTable align-middle custom-table">
     ...
     <tbody>
        ...
        <tr>
            ...
            <td>
             <a type="button" href="{{ route('companyinfo.edit', $data->company_id) }}" class="btn btn-link btn-sm text-primary" data-bs-toggle="tooltip" data-bs-placement="top"
              ...
              title="Delete" onclick="deleteUser({{ $data->company_id }})"><i class="fa fa-trash"></i></a>
            </td>
           </tr>
        @endforeach
     </tbody>
...
<script type="text/javascript">
    function deleteUser(params) {
        Swal.fire({
            title: 'Do You Want To Delete The Company Data?',
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    ...
                    Swal.fire('Company Data Has Been Deleted', '', 'success')
