                ...
                <div class="col">
                    <ol class="breadcrumb bg-transparent mb-0">
                        ...
                        <li class="breadcrumb-item"><a class="text-secondary"
                                href="{{ url('money-reciept-sponsor') }}">Sponsor
                                Money
                                Receipt</a>
                        </li>
                        <li class="breadcrumb-item active" aria-current="page">List of Sponsor Money Reciept</li>
                    </ol>
                </div>
                    ...
                    <div class="card-body">
                        <div class="card p-3">
                            <div class="border-bottom pb-2">
                                <textarea class="form-control address" readonly>{{ $reciept->money_reciept_payment_to }}
                                </textarea>
                                <div id="logo">
                                    <div id="logohelp">
                                ...
                                <table class="meta">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <textarea class="form-control" readonly>{{ $reciept->money_reciept_voucher_no }}</textarea>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="meta-head">Date</td>
                                            <td>
                                                <textarea class="form-control" id="date" readonly>{{ $reciept->money_reciept_payment_date }}</textarea>
                                            </td>
                                        </tr>
                                        <tr>
                                    ...
                                    <tr class="item-row">
                                        <td class="item-name">
                                            <div class="delete-wpr">
                                                <textarea readonly>{{ $reciept->sponsor_name }}</textarea>
                                            </div>
                                        </td>
                                        <td class="description">
                                            <textarea readonly>{{ $reciept->sponsor_opening_balance }}</textarea>
                                        </td>
                                        <td>
                                            <textarea class="cost" readonly>{{ $reciept->money_reciept_total_amount }}</textarea>
                                        </td>
                                        <td>
                                            <textarea class="qty" readonly>{{ $reciept->money_reciept_total_discount }}</textarea>
                                        </td>
                                        <td><span
                            ...
                            <div class="footer-note mt-5">
                                <h5>Note</h5>
                                <textarea class="form-control bg-light" readonly>{{ $reciept->money_reciept_note }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
