            ...
            <div class="row g-3 mb-3 align-items-center">
                <div class="col">
                    <ol class="breadcrumb bg-transparent mb-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">List of Sponsor Money Receipt</li>
                    </ol>
                </div>
            ...
            <div class="col-md-12 mt-4">
                <div class="card">
                    <div class="card-header">
                        <h3>List of Sponsor Money Receipt</h3>

                        <div class="col text-md-end">
                            <a class="btn btn-primary" href="{{ url('money-reciept-sponsor/create') }}"><i
                                    class="fa fa-list me-2"></i>Create Sponsor
                                Money Receipt</a>
                        </div>
                    </div>
                    <div class="card-body">
                            ...
                            <tbody>
                                @foreach ($list as $row)
                                    <tr>
                                        ...
                                        <td><a href="{{ 'money-reciept-sponsor/' . $row->money_reciept_voucher_no . '/' . 'edit' }}"
                                                class="btn btn-sm btn-warning">Edit</a>
                                            <button class="btn btn-sm btn-danger"
                                                onclick="deleteMoneyReciept({{ $row->money_reciept_voucher_no }})">Delete</button>
                                            <a href="{{ 'money-reciept-sponsor/' . $row->money_reciept_voucher_no }}"
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        ...
                        type: 'DELETE',
                        url: "money-reciept-sponsor" + '/' + params,
