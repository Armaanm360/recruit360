                     ...
                     <form method="POST" id="sponsor_reciept">
                         ...
                         <div class="row g-2">
                             <div class="col-8 mb-4">
                                 <h4>Create Sponsor Money Reciept</h4>
                             </div>
                             ...
                             <div class="col-lg-8 col-md-8">
                                 <div class="form-floating">
                                     <span class="float-label">
                                         ...
                                         <label class="form-label" for="agentID">Search Sponsor </label>
                                     </span>
             ...
             $("#sponsor_reciept").submit(function(e) {
                 ...
                 $.ajax({
                     ...
                     success: function(data, textStatus, jqXHR) {
                         ...
                         window.location.href = "{{ url('money-reciept-sponsor') }}/" + data
