...
@section('content')
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h6 class="card-title mb-0">Edit Status</h6>
                        </div>
                        <div class="card-body">
                                ...
                                <input type="hidden" name="status_id" value="{{$status->id}}">
                                    <div class="col-lg-4 col-md-6 col-sm-6">
                                        <span class="float-label">
                                            <select class="form-control" name="status_for" id="status_for">
                                                ...
                                                <option value="PASSPORT" @if($status->status_for=='PASSPORT') selected @endif>Passport Management</option>
                                                <option value="OTHER" @if($status->status_for=='OTHER') selected @endif>Others</option>
                                            </select>
                                    ...
                                    <div class="col-lg-4 col-md-6 col-sm-6">
                                        <span class="float-label">
                                            ...
                                            placeholder="Status" name="status" value="{{$status->status}}">
                                    ...
                                    <div class="col-lg-4 col-md-6 col-sm-6">
                                        <span class="float-label">
                                            <input type="text" class="form-control form-control-lg" id="status_entry"
                                                placeholder="Status Entry Id" name="status_entry" value="{{$status->status_entry}}" readonly>
    ...
    <script type="text/javascript">
        ...
        $("#status_form").submit(function(e) {
            ...
            let getpassport_id = $("[name=status_id]").val();
            $('#loader').show();
            $.ajax({
                headers: {
