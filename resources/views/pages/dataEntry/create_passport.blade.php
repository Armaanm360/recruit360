            ...
            <div class="row g-3 mb-3 align-items-center">
                <div class="col">
                    <ol class="breadcrumb bg-transparent mb-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Create Passport</li>
                    </ol>
                </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h6 class="card-title mb-0">Create Passport</h6>
                        </div>
                        <div class="card-body">
                            <form class="row g-3 maskking-form" id="passport_form">
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-6">
                                    <span class="float-label">
                                        ...
                                        <input type="hidden" class="form-control form-control-lg" id="hiddenClientId"
                                            placeholder="Client" name="clientId">
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-6">
                                    <span class="float-label">
                                        ...
                                        <label class="form-label" for="passport_no">Passport Number<span
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-6">
                                    <span class="float-label">
                                        <input type="text" class="form-control form-control-lg" id="passport_name"
                                            placeholder="Name" name="passport_name">
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-6">
                                    <span class="float-label">
                                        ...
                                        <label class="form-label" for="date_of_passport_issue">Date of Issue
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-6">
                                    <span class="float-label">
                                        <input type="date" class="form-control form-control-lg"
                                            id="date_of_passport_expiry" placeholder="DOE"
                                            name="date_of_passport_expiry">
                                        <label class="form-label" for="date_of_passport_expiry">Date of Expiry<span
                                                class="text-danger">*</span></label>
                                    </span>
                                </div>
                                <div class="col-lg-4 col-md-6 col-sm-6">
                                    <span class="float-label">
                                        <input type="number" class="form-control form-control-lg" id="duration_left"
                                            placeholder="Duration" name="duration_left">
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-6">
                                    <span class="float-label">
                                        ...
                                        <label class="form-label" for="passport_document">Passport Document</label>
                                    </span>
                                </div>
                                <div class="col-lg-4 col-md-6 col-sm-6">
                                    <span class="float-label">
