            ...
            <div class="row g-3 mb-3 align-items-center">
                <div class="col">
                    <ol class="breadcrumb bg-transparent mb-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Manpower office List</li>
                    </ol>
                </div>
                                ...
                                @foreach ($officeList as $data)
                                    <tr>
                                        ...
                                        <td class="dt-body-left">
                                            <a href="{{url('office-wise-client-list')}}/{{$data->office_slug}}" class="btn btn-sm btn-info">Clients</a>
                                            {{-- <a href="{{url('office-wise-client-list')}}/{{$data->manpower_client_id}}" class="btn btn-sm btn-info">Clients</a> --}}
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
