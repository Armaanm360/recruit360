                            ...
                            <tbody>
                                @foreach ($passportData as $passport)
                                    <tr>
                                        ...
                                        <td>{{ $passport->passport_reference }}</td>
                                        <td>{{ $passport->date_of_passport_issue }}</td>
                                        <td>{{ $passport->date_of_passport_expiry }}</td>
                                        <td>{{ $passport->duration_left }}</td>
                                        <td>{{ $passport->note }}</td>
                                        <td class="dt-body-left">
                                            <a type="button" href="{{ 'passport/' . $passport->id . '/' . 'edit' }}"
                                            ...
                                            <a type="button" class="btn btn-link btn-sm text-danger"
                                                ...
                                                onclick="deleteUser({{ $passport->id }})"><i class="fa fa-trash"></i></a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
