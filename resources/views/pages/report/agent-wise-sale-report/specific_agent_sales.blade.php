            ...
            <div class="row g-3 mb-3 align-items-center">
                <div class="col">
                    <ol class="breadcrumb bg-transparent mb-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Agent Wise Sales Report</li>
                    </ol>
                </div>
            </div>
        </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h6 class="card-title mb-0">Agent Wise Sales Report</h6>
                        </div>
                        <div class="card-body">
                                ...
                                <div class="col-lg-3 col-sm-12">
                                    <span class="float-label">
                                        <input type="text" class="form-control form-control-lg" id="agentID"
                                            placeholder="Search Agent" name="agent_name" readonly
                                            value="{{ getAgentName($agent_id) }}">
                                        <label class="form-label" for="agentID">Agent</label>
                                    </span>
                                    <input type="hidden" id="hiddenAgentID" name="agent_id" value="{{ $agent_id }}">
    ...
    <script type="text/javascript">
        $("#search_form").submit(function(e) {
            ...
            $.ajax({
                ...
                method: "POST",
                url: "{{ url('report/specific-agent-wise-sales-store') }}",
                data: data,
                cache: false,
                contentType: false,
                processData: false,
