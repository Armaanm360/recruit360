            ...
            <div class="row g-3 mb-3 align-items-center">
                <div class="col">
                    <ol class="breadcrumb bg-transparent mb-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Account Collection Report</li>
                    </ol>
                </div>
            </div>
        </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h6 class="card-title mb-0">Account Collection Report</h6>
                        </div>
                        <div class="card-body">
    ...
    <script type="text/javascript">
        ...
        $("#search_form").submit(function(e) {
            ...
            $.ajax({
                ...
                method: "POST",
                url: "{{ url('report/get-accounts-collection-report') }}",
                data: data,
                cache: false,
                contentType: false,
                processData: false,
