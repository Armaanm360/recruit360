            ...
            <div class="row g-3 mb-3 align-items-center">
                <div class="col">
                    <ol class="breadcrumb bg-transparent mb-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Sponsor Ledger</li>
                    </ol>
                </div>
            </div>
        </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h6 class="card-title mb-0">Sponsor Ledger</h6>
                        </div>
                        <div class="card-body">
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-12">
                                    <span class="float-label">
                                        ...
                                        <input type="hidden" class="form-control form-control-lg" id="hiddenClientId"
                                            placeholder="Client" name="sponsor_id">
                                        <label class="form-label" for="sponsor_id">Sponsor Name</label>
                                    </span>
                                </div>
                                <div class="col-lg-3 col-md-3 col-sm-12">
                                    <span class="float-label">
    ...
    <script type="text/javascript">
        ...
        $("#search_form").submit(function(e) {
            ...
            $.ajax({
                ...
                method: "POST",
                url: "{{ url('report/get-sponsor-ledger') }}",
                data: data,
                cache: false,
                contentType: false,
                processData: false,
