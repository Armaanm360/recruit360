            ...
            <div class="row g-3 mb-3 align-items-center">
                <div class="col">
                    <ol class="breadcrumb bg-transparent mb-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Agent Ledger</li>
                    </ol>
                </div>
            </div>
        </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h6 class="card-title mb-0">Agent Ledger</h6>
                        </div>
                        <div class="card-body">
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-12">
                                    <span class="float-label">
                                        ...
                                        <input type="hidden" class="form-control form-control-lg" id="hiddenClientId"
                                            placeholder="Client" name="agent_id">
                                        <label class="form-label" for="agent_id">Agent Name</label>
                                    </span>
                                </div>
    ...
    <script type="text/javascript">
        $("#search_form").submit(function(e) {
            ...
            $.ajax({
                ...
                method: "POST",
                url: "{{ url('report/get-agent-ledger') }}",
                data: data,
                cache: false,
                contentType: false,
                processData: false,
