            ...
            <div class="row g-3 mb-3 align-items-center">
                <div class="col">
                    <ol class="breadcrumb bg-transparent mb-0">
                        ...
                        <li class="breadcrumb-item"><a class="text-secondary" href="{{ url('sponser') }}">Report</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Deligate Ledger</li>
                    </ol>
                </div>
            </div>
        </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h6 class="card-title mb-0">Deligate Ledger</h6>
                        </div>
                        <div class="card-body">
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-12">
                                    <span class="float-label">
                                        ...
                                        <input type="hidden" class="form-control form-control-lg" id="hiddenClientId"
                                            placeholder="Delegate" name="deligate_id">
                                        <label class="form-label" for="agent_id">Deligate Name</label>
                                    </span>
                                </div>
                                <div class="col-lg-3 col-md-3 col-sm-12">
                                    <span class="float-label">
                                        <input type="date" class="form-control form-control-lg" id="start_date"
                                            placeholder="sponsor Entry Id" name="start_date">
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-12">
                                    <span class="float-label">
                                        <input type="date" class="form-control form-control-lg" id="end_date"
                                            placeholder="sponsor Entry Id" name="end_date">
                                        <label class="form-label" for="TextInput">End Date</label>
                                    </span>
                                </div>
                                <div class="col-lg-3 col-md-3 col-sm-12">
    ...
    <script type="text/javascript">
        ...
        $("#search_form").submit(function(e) {
            ...
            $.ajax({
                ...
                method: "POST",
                url: "{{ url('report/get-deligate-ledger') }}",
                data: data,
                cache: false,
                contentType: false,
                processData: false,
