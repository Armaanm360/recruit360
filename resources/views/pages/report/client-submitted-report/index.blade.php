            ...
            <div class="row g-3 mb-3 align-items-center">
                <div class="col">
                    <ol class="breadcrumb bg-transparent mb-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Client Submiited Report</li>
                    </ol>
                </div>
            </div>
        </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h6 class="card-title mb-0">Client Submiited Report</h6>
                        </div>
                        <div class="card-body">
    ...
    <script type="text/javascript">
        ...
        $("#search_form").submit(function(e) {
            ...
            $.ajax({
                ...
                method: "POST",
                url: "{{ url('get-client-submitted-report') }}",
                data: data,
                cache: false,
                contentType: false,
                processData: false,
