            ...
            <div class="row g-3 mb-3 align-items-center">
                <div class="col">
                    <ol class="breadcrumb bg-transparent mb-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Client Wise Sales & Collection</li>
                    </ol>
                </div>
            </div>
        </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h6 class="card-title mb-0">Client Wise Sales & Collection</h6>
                        </div>
                        <div class="card-body">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-12">
                                    <span class="float-label">
                                        <input type="text" class="form-control form-control-lg" id="tags"
                                            placeholder="Client" name="client_name">
    ...
    <script type="text/javascript">
        ...
        $("#search_form").submit(function(e) {
            ...
            $.ajax({
                ...
                method: "POST",
                url: "{{ url('report/get-client-wise-collection-sales') }}",
                data: data,
                cache: false,
                contentType: false,
                processData: false,
