                ...
                <div class="card">
                    <div class="card-header">
                        <h5 style="color: darkcyan;font-weight: bold">Gross Profit Loss
                            @php
                                ...
                                $refundProfit = $profitLoss->get_refund_profit($from, $to);
                                $grossProfit = $salesProfit - $refundProfit;
                    ...
                    <div class="card-body">
                        <table id="myTable" class="table display dataTable table-hover" style="width:100%">
                            ...
                            <tr>
                                <td colspan="1" style="text-align: right;font-weight:bold;">Refund Profit: </td>
                                <td style="text-align:left;font-weight:bold;color: black;">{{ $refundProfit }}</td>

                            </tr>
                            <tr>
                                <td colspan="1" style="text-align: right;font-weight:bold;color: #684b4b">Gross
                                    Profit Loss </td>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <table id="myTable" class="table display dataTable table-hover" style="width:100%">
                            ...
                            <tr>
                                <td colspan="1" style="text-align: center;font-weight:bold;">Money Receipt Discount:
                                </td>
                                <td style="text-align:left;font-weight:bold;color: black;">{{ $moneyReceiptDiscount }}
                                </td>
                            ...
                            <tr>
                                <td colspan="1" style="text-align: right;font-weight:bold;color: red">Total Expense:
                                </td>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <table id="myTable" class="table display dataTable table-hover" style="width:100%">
                            ...
                            <tr>
                                <td colspan="1" style="text-align: center;font-weight:bold;">Total Gross Profit Loss:
                                </td>
                            ...
                            <tr>
                                <td colspan="1" style="text-align: right;font-weight:bold;color:#8f0f0f">Net Profit
                                    Loss: </td>
