                    ...
                    <div class="card-body">
                        <div class="card p-3">
                                    ...
                                    <tr class="item-row">
                                        <td class="item-name">
                                            <div class="delete-wpr">
                                                <p>{{ $reciept->agent_name }}</p>
                                            </div>
                                        </td>
                                        <td class="description">
                                            <p>{{ $reciept->agent_opening_balance }}</p>
                                        </td>
                                        <td>
                                            <p class="cost">{{ $reciept->money_reciept_total_amount }}</p>
                                        </td>
                                        <td>
                                            <p class="qty">{{ $reciept->money_reciept_total_discount }}</p>
                                        </td>
                                        <td><span
                            ...
                            <div class="footer-note mt-5">
                                <h5>Note</h5>
                                <p>{{ $reciept->money_reciept_note }}</p>
                            </div>
                        </div>
                    </div>
                </div>
