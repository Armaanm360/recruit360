            ...
            <div class="row g-3 mb-3 align-items-center">
                <div class="col">
                    <ol class="breadcrumb bg-transparent mb-0">
                        ...
                        <li class="breadcrumb-item"><a class="text-secondary" href="{{ url('clients') }}">VISA Forms</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Saudi VISA</li>
                    </ol>
                </div>
            </div>
        </div>
                            ...
                            <tbody>
                                @foreach ($client as $client)
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="{{ url('saudi/visa/form') }}/{{$client->client_id}}" class="btn btn-sm btn-success">View Form</a>
