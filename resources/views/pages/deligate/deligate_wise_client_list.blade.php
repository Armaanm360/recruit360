            ...
            <div class="row g-3 mb-3 align-items-center">
                <div class="col">
                    <ol class="breadcrumb bg-transparent mb-0">
                        ...
                        <li class="breadcrumb-item"><a class="text-secondary" href="{{ url('deligates') }}">Deligate</a></li>
                        <li class="breadcrumb-item active" aria-current="page">List Deligate</li>
                    </ol>
                </div>
            ...
            <div class="col-md-12 mt-4">
                <div class="card">
                    <div class="card-header">
                        <h3> List of Clients under {{$deligate->deligate_name}}</h3>
                    </div>
                    <div class="card-body">
