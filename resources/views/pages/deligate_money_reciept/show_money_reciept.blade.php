            ...
            <div class="row g-3 mb-3 align-items-center">
                <div class="col">
                    <ol class="breadcrumb bg-transparent mb-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">List of deligate Money Reciept</li>
                    </ol>
                </div>
            ...
            <div class="col-12">
                <div class="card print_invoice">
                    <div class="card-header border-bottom fs-4">
                        <h5 class="card-title mb-0">deligate
                            Money
                            Reciept</h5>
                    </div>
                    <div class="card-body">
                        <div class="card p-3">
                            ...
                            <table class="items">
                                <tbody>
                                    <tr>
                                        <th>deligate Name</th>
                                        <th>deligate Opening Balance</th>
                                    ...
                                    <tr class="item-row">
                                        <td class="item-name">
                                            <div class="delete-wpr">
                                                <textarea readonly>{{ $reciept->deligate_name }}</textarea>
                                            </div>
                                        </td>
                                        <td class="description">
                                            <textarea readonly>{{ $reciept->deligate_opening_balance }}</textarea>
                                        </td>
                                        <td>
