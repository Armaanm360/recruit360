                     ...
                     <form method="POST" id="deligate_reciept">
                         ...
                         <div class="row g-2">
                             <div class="col-8 mb-4">
                                 <h4>Edit deligate Money Reciept</h4>
                             </div>
                             ...
                             <div class="col-lg-8 col-md-8">
                                 <div class="form-floating">
                                     ...
                                     <input type="hidden" id="" name="deligate_transaction_id"
                                         value="{{ $reciept->deligate_transaction_id }}">
         ...
         $(document).ready(function() {
             ...
             $("#deligate_reciept").submit(function(e) {
                 ...
                 $.ajax({
                     ...
                     method: "POST",
                     url: "{{ url('money-reciept-deligate') }}/" + money_reciept_voucher_no,
                     data: data,
                     cache: false,
                     contentType: false,
                     processData: false,
