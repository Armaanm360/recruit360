...
@section('content')
                ...
                <div class="col">
                    <ol class="breadcrumb bg-transparent mb-0">
                        ...
                        <li class="breadcrumb-item"><a class="text-secondary" href="{{ url('/police-clearance') }}">Police
                                Clearance</a></li>
                        <li class="breadcrumb-item active">Edit Police Clearance</li>
                    </ol>
                </div>
            </div> <!-- .row end -->
            <div class="row align-items-center">
                <div class="col">
                    <h1 class="fs-5 color-900 mt-1 mb-0">Edit Police Clearance !</h1>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4>Edit Police Clearance Information</h4>
                        </div>
                        <div class="card-body">
                            <form class="row g-3 maskking-form" id="PoliceClearanceForm">
                                @csrf
                                {{-- ---------Hidden INPUT Primery Id --------------- --}}
                                <input type="hidden" class="form-control form-control-lg" id="police_clearance_id"
                                    placeholder="Client Name" name="police_clearance_id"
                                    value="{{ $policeclearance[0]->police_clearance_id }}">
                                ...
                                <div class="col-6">
                                    <span class="float-label">
                                        ...
                                        <input type="text" class="form-control form-control-lg"
                                            ...
                                            name="police_clearance_client_name"
                                            value="{{ $policeclearance[0]->client_name }}">

                                        <input type="hidden" class="form-control form-control-lg"
                                            id="hidden_police_clearance_client_id" placeholder="Client Name"
                                            name="police_clearance_client_id"
                                            value="{{ $policeclearance[0]->police_clearance_client_id }}">
                                ...
                                <div class="col-6">
                                    <span class="float-label">
                                        <input type="text" class="form-control form-control-lg" id="police_clearance_no"
                                            ...
                                            value="{{ $policeclearance[0]->police_clearance_no }}">
                                ...
                                {{-- <div class="col-lg-4 col-md-6 col-sm-6">
                                    <span class="float-label">
                                        ...
                                        <input type="hidden" class="form-control form-control-lg" id="hiddenVendorId"
                                            ...
                                            value="{{ $policeclearance[0]->police_clearance_vendor_id }}">
                                ...
                                <div class="col-6">
                                    <label class="form-group float-label">
                                        <select class="form-control form-control-lg custom-select"
                                            ...
                                            value="{{ $policeclearance[0]->police_clearance_status }}">
                                            <option value="" disabled selected>
                                                Select
                                            </option>
                                            <option value="yes" @if ($policeclearance[0]->police_clearance_status == 'yes') selected @endif>Yes
                                            </option>
                                            <option value="no" @if ($policeclearance[0]->police_clearance_status == 'no') selected @endif>No
                                            </option>
                                            =
                                        </select>
                                ...
                                {{-- <div class="col-6">
                                    <span class="float-label">
                                        <input type="number" class="form-control form-control-lg" id="visa_amount"
                                            ...
                                            value="{{ $policeclearance[0]->police_clearence_processing_cost }}">
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-6">
                                    <span class="float-label">
                                        <textarea name="note" id="note" class="form-control">{{ $policeclearance[0]->note }}</textarea>
    ...
    <script type="text/javascript">
        $("#PoliceClearanceForm").submit(function(e) {
            e.preventDefault();
            $(".error_msg").html('');
            var data = $('#PoliceClearanceForm').serializeArray();
            $.ajax({
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                },
                method: "PATCH",
                url: "{{ url('police-clearance') }}/" + $("[name=police_clearance_id]").val(),
                data: data,
                cache: false,
                success: function(data, textStatus, jqXHR) {
                    ...
                    Swal.fire({
                        position: 'top-end',
                        icon: 'success',
                        title: 'Police Clearance Information has been updated successfully.',
