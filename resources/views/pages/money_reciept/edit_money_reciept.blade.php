...
@section('content')
    ...
    <form class="row maskking-form" id="money_receipt_form">
        ...
        <input type="hidden" name="money_reciept_id" id="money_reciept_id" value="{{$moneyReceipt->money_reciept_id}}">
        <input type="hidden" name="money_reciept_client_transaction_id" value="{{$moneyReceipt->money_reciept_client_transaction_id}}">
        <input type="hidden" name="money_reciept_account_transaction_id" value="{{$moneyReceipt->money_reciept_account_transaction_id}}">
                                    ...
                                    <table class="items">
                                        ...
                                        <div id="billingDetailsList">
                                            <tr class="item-row billing-details-row">
                                                ...
                                                <td><textarea class="cost " data-row="1" name="money_reciept_amount">{{$moneyReceipt['money_reciept_total_amount']}}</textarea></td>
                                                <td><textarea class="qty " name="money_reciept_discount" data-row="1">{{$moneyReceipt['money_reciept_total_discount']}}</textarea></td>
                                                <td><input type="date" class="qty" data-row="1" name="money_reciept_date" value="{{$moneyReceipt['money_reciept_payment_date']}}"></td>
                                            </tr>
                                        </div>
                                        </tbody>
                                    </table>
