            ...
            <div class="row g-3 mb-3 align-items-center">
                <div class="col">
                    <ol class="breadcrumb bg-transparent mb-0">
                        ...
                        <li class="breadcrumb-item"><a class="text-secondary" href="{{ url('invoice') }}">Money Receipt</a></li>
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="col text-md-end">
                            <a class="btn btn-primary" href="{{ url('money-reciept/create') }}"><i class="fa fa-list me-2"></i>Create
                                Money Receipt</a>
                        </div>
                    </div>
                    <div class="card-body">
                            ...
                            <tbody>
                                @foreach ($list as $row)
                                    <tr>
                                        ...
                                        <td><a href="{{ 'money-reciept/' . $row->money_reciept_invoice_no . '/' . 'edit' }}"
                                                class="btn btn-sm btn-warning">Edit</a>
                                            <button class="btn btn-sm btn-danger"
                                                onclick="deleteMoneyReciept({{ $row->money_reciept_id  }})">Delete</button>
                                            <a href="{{ 'money-reciept/' . $row->money_reciept_id  }}"
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        ...
                        type: 'DELETE',
                        url: "money-reciept" + '/' + params,
                        success: function(data) {
                            window.location.href = "{{ url('money-reciept') }}/";
