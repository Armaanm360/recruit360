  ...
  <nav class="navbar">
   ...
   <div class="d-flex">
    ...
    <a href="{{url('/home')}}" class="brand-icon d-flex align-items-center mx-2 mx-sm-3 text-primary">
        ...
        @else
        <img src="{{asset('public/frontend')}}/assets/img/m360ict.gif" alt="">
        @endif
      ...
      <div id="NotificationsDiv" class="dropdown-menu shadow rounded-4 border-0 p-0 m-0">
       <div class="card w380">
        ...
        <ul class="nav nav-tabs tab-card d-flex text-center" role="tablist">
         {{-- <li class="nav-item flex-fill"><a class="nav-link active" data-bs-toggle="tab" href="#Noti-tab-Message"
          ...
          <ul class="list-unstyled list mb-0">
           <li class="py-2 mb-1 border-bottom">
            <a href="javascript:void(0);" class="d-flex">
             <img class="avatar rounded-circle" src="{{ asset('public/frontend') }}/assets/img/xs/avatar5.jpg" alt="">
           ...
           <li class="py-2 mb-1 border-bottom">
            <a href="javascript:void(0);" class="d-flex">
             <img class="avatar rounded-circle" src="{{ asset('public/frontend') }}/assets/img/xs/avatar6.jpg" alt="">
             <div class="flex-fill ms-3">
           ...
           <li class="py-2 mb-1 border-bottom">
            <a href="javascript:void(0);" class="d-flex">
             <img class="avatar rounded-circle" src="{{ asset('public/frontend') }}/assets/img/xs/avatar1.jpg" alt="">
             <div class="flex-fill ms-3">
           ...
           <li class="py-2 mb-1 border-bottom">
            <a href="javascript:void(0);" class="d-flex">
             <img class="avatar rounded-circle" src="{{ asset('public/frontend') }}/assets/img/xs/avatar3.jpg" alt="">
             <div class="flex-fill ms-3">
           ...
           <li class="py-2 mb-1 border-bottom">
            <a href="javascript:void(0);" class="d-flex">
             <img class="avatar rounded-circle" src="{{ asset('public/frontend') }}/assets/img/xs/avatar4.jpg" alt="">
             <div class="flex-fill ms-3">
           ...
           <li class="py-2">
            <a href="javascript:void(0);" class="d-flex">
             <img class="avatar rounded-circle" src="{{ asset('public/frontend') }}/assets/img/xs/avatar7.jpg" alt="">
             <div class="flex-fill ms-3">
          ...
          <ul class="list-unstyled list mb-0">
           ...
           <li class="py-2 mb-1 border-bottom">
            <a href="javascript:void(0);" class="d-flex">
             ...
             <div class="flex-fill ms-3">
              <p class="mb-0">Website visits from Twitter is <strong class="text-danger">27% higher</strong> than last
               week.</p>
           ...
           <li class="py-2 mb-1 border-bottom">
            <a href="javascript:void(0);" class="d-flex">
             ...
             <div class="flex-fill ms-3">
              <p class="mb-0">Campaign <strong class="text-primary">Holiday Sale</strong> is nearly reach budget limit.
              </p>
      ...
      <div class="dropdown-menu rounded-4 shadow border-0 p-0" data-bs-popper="none">
       <div class="card">
        <div class="row g-1 text-center p-3" style="width: 302px;">
         <div class="col-6">
          <a class="card p-3 color-600 lift align-items-center" href="{{"home"}}" title="">
         ...
         <div class="col-6">
          <a class="card p-3 color-600 lift align-items-center" href="{{"invoice"}}" title="">
           <svg viewBox="0 0 16 16" width="30px" class="mb-3" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            <path
             d="M5.5 2A3.5 3.5 0 0 0 2 5.5v5A3.5 3.5 0 0 0 5.5 14h5a3.5 3.5 0 0 0 3.5-3.5V8a.5.5 0 0 1 1 0v2.5a4.5 4.5 0 0 1-4.5 4.5h-5A4.5 4.5 0 0 1 1 10.5v-5A4.5 4.5 0 0 1 5.5 1H8a.5.5 0 0 1 0 1H5.5z" />
            <path class="fill-secondary" d="M16 3a3 3 0 1 1-6 0 3 3 0 0 1 6 0z" />
           </svg>
           <p class="mb-0 color-600">Invoice</p>
           <small class="text-muted">View All</small>
          </a>
         </div>
         <div class="col-6">
          <a class="card p-3 color-600 lift align-items-center" href="{{"money-reciept"}}" title="">
           <svg viewBox="0 0 16 16" width="30px" class="mb-3" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            <path
           ...
           <p class="mb-0 color-600">Money</p>
           <small class="text-muted">Receipt</small>
          </a>
         </div>
         <div class="col-6">
          <a class="card p-3 color-600 lift align-items-center" href="{{"account"}}" title="">
           <svg viewBox="0 0 16 16" width="30px" class="mb-3" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            <path
           ...
           <p class="mb-0 color-600">Account</p>
           <small class="text-muted">View All</small>
          </a>
         </div>
        </div> <!-- .row end -->
     ...
     <div class="dropdown morphing scale-left user-profile mx-lg-3 mx-2">
      <a class="nav-link dropdown-toggle rounded-circle after-none p-0" href="#" role="button"
       ...
       <img class="avatar img-thumbnail rounded-circle shadow"
        src="{{asset('public/frontend')}}/assets/img/profile_av.png" alt="">
      </a>
      <div class="dropdown-menu border-0 rounded-4 shadow p-0">
       <div class="card border-0 w240">
        <div class="card-body border-bottom d-flex">
         <img class="avatar rounded-circle" src="{{asset('public/frontend')}}/assets/img/profile_av.png" alt="">
         <div class="flex-fill ms-3">
        ...
        <div class="list-group m-2 mb-3">
         {{-- <a class="list-group-item list-group-item-action border-0" href="page-profile.html"><i
